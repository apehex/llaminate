...
class PreprocessTest(tf.test.TestCase):
    def setUp(self):
        ...
        self._config = {'batch_dim': 8, 'sample_dim': 128, 'token_dim': 16, 'embed_dim': 256, 'weight': True, 'features': ['question']}
    ...
    def test_specs(self):
        ...
        self.assertEqual(__weights_spec.shape, (self._config['batch_dim'], 4 * self._config['sample_dim']))
